  ...
  <div>
    ...
    <div class="container home">
      <div class="home-hero">
        ...
        <h1>Printable cover art for your Skylanders NFC cards &amp; coins</h1>
        <p>
          Pick a game, choose a creator's cover set, curate the covers you want, and print a
          size-accurate sheet.
        </p>
      </div>

      <div class="home-sub mono">Choose a game</div>
      <div class="game-grid">
